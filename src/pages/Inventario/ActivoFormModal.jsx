        ...
        <Modal open={open} onClose={onClose}>
            <ModalDialog component="form" onSubmit={onSubmit}>
                ...
                <Stack spacing={1.5} mt={1}>
                    <FormControl><FormLabel>Código</FormLabel>
                        <Input value={form.codigo || ""} onChange={e => setForm({ ...form, codigo: e.target.value })} />
                    </FormControl>
                    <FormControl><FormLabel>Nombre</FormLabel>
                    ...
                    <FormControl><FormLabel>Tipo</FormLabel>
                        <Select value={form.tipo || "Otro"} onChange={(_, v) => setForm({ ...form, tipo: v })}>
                            {TIPOS.map(t => <Option key={t} value={t}>{t}</Option>)}
                        </Select>
                    </FormControl>
                    <FormControl><FormLabel>Estatus</FormLabel>
                        <Select value={form.estatus || "Activo"} onChange={(_, v) => setForm({ ...form, estatus: v })}>
